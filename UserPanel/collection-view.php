...
<body>
    <section class="Exercise-info">
        <div class="container">
            <div class="row">
                <h1 class="Exercise-info-header mb-5"><?php echo $resultCheck['Save_exercise_name']; ?></h1>
                <div class="Exercise-content mb-4">
                    <label for="" class="Exercise-asset">Exercise Name: </label><p class="profile ms-3"> <?php echo $resultCheck['Save_exercise_name']; ?>  </p>
                </div>
                <div class="Exercise-content mb-4">
                    <label for="" class="Exercise-asset">Exercise Duration: </label><p class="profile ms-3">
                        <?php echo $resultCheck['Save_exercise_duration']; ?>
                    </p>
                </div>
                <div class="Exercise-content mb-4">
                    <label for="" class="Exercise-asset">Exercise Link: </label> <a href="<?php echo $resultCheck['Save_exercise_link']; ?>" class="link profile ms-3" target="_blank"><?php echo $resultCheck['Save_exercise_link']; ?></a>
                </div>
                <div class="Exercise-content mb-4">
                    <label for="" class="Exercise-asset">Exercise Description: </label>
                    
                </div>
                <br><p class="exercise-description"> <?php echo $resultCheck['Save_exercise_description']; ?> </p>
            </div>
        </div>
    </section>
    <footer class="footer">

<?php  include("includes/login_user.php"); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="form-main">
        <div class="container">
            ...
            <div class="form-contain ">
                ...
                <select name="role" id="role my-select" name="role">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name = "pass" class="form-control form-inp" placeholder="Password">
                </div>
                <div class="btn-sbmt ">
                        <input type="submit" name = "login" class="btn-reg" value="Login">
                    </div>
                    <div class="link mt-3">
                        <p class="link-text">Patient didn't have an account? <a href="registration.php" >Register here</a> </p>
                    </div>
                    <div class="link">
                    <p class="link-text">Forgotten your login details? <a href="forget.php">Get help with logging in.</a></p>
                    </div>
                </form>
            </div>
            </div>
